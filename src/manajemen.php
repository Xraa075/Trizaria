...
th:nth-child(2),
td:nth-child(2) {
    width: 17%; /* Lebar kolom Nama */
}

th:nth-child(3),
td:nth-child(3) {
    width: 18%; /* Lebar kolom Detail */
}

th:nth-child(4),
td:nth-child(4) {
    width: 15%; /* Lebar kolom Harga */
}

th:nth-child(5),
td:nth-child(5) {
    width: 10%; /* Lebar kolom Stok */
}
...
a.plus {
    display: block; /* Mengubah anchor menjadi elemen block */
    width: 89%; /* Lebar elemen */
    border-radius: 10px;
    background-color: #FF9C3D;
    ...
    margin: auto; /* Gunakan margin auto untuk posisi horizontal, berikan margin atas dan bawah yang sesuai */
}
...
<body>
    ...
    <div class="header"><h1>Menejemen Makanan</h1></div>
    <div class="mm">
        <table>
            <tr>
